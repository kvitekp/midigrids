...
#ifndef MIDIGRIDS_UI_PAGES_MAP_XY_PAGE_H_
#define MIDIGRIDS_UI_PAGES_MAP_XY_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class MapXYPage : public UiPage {
 public:
  MapXYPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(MapXYPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_MAP_XY_PAGE_H_
