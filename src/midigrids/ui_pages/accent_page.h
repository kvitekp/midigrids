...
#ifndef MIDIGRIDS_UI_PAGES_ACCENT_PAGE_H_
#define MIDIGRIDS_UI_PAGES_ACCENT_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class AccentPage : public UiPage {
 public:
  AccentPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(AccentPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_ACCENT_PAGE_H_
