...
#ifndef MIDIGRIDS_UI_PAGES_TRK_VELOCITY_PAGE_H_
#define MIDIGRIDS_UI_PAGES_TRK_VELOCITY_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class TrkVelocityPage : public UiPage {
 public:
  TrkVelocityPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(TrkVelocityPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_TRK_VELOCITY_PAGE_H_
