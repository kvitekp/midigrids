...
#ifndef MIDIGRIDS_UI_PAGES_MAP_CHAOS_PAGE_H_
#define MIDIGRIDS_UI_PAGES_MAP_CHAOS_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class MapChaosPage : public UiPage {
 public:
  MapChaosPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(MapChaosPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_MAP_CHAOS_PAGE_H_
