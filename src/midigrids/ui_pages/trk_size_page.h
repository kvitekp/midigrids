...
#ifndef MIDIGRIDS_UI_PAGES_TRK_SIZE_PAGE_H_
#define MIDIGRIDS_UI_PAGES_TRK_SIZE_PAGE_H_
...
class TrkSizePage : public UiPage {
 public:
  TrkSizePage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(TrkSizePage);
};
...
#endif  // MIDIGRIDS_UI_PAGES_TRK_SIZE_PAGE_H_
