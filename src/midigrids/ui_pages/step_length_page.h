...
#ifndef MIDIGRIDS_UI_PAGES_STEP_LENGTH_PAGE_H_
#define MIDIGRIDS_UI_PAGES_STEP_LENGTH_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class StepLengthPage : public UiPage {
 public:
  StepLengthPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(StepLengthPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_STEP_LENGTH_PAGE_H_
