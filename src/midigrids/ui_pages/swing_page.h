...
#ifndef MIDIGRIDS_UI_PAGES_SWING_PAGE_H_
#define MIDIGRIDS_UI_PAGES_SWING_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class SwingPage : public UiPage {
 public:
  SwingPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(SwingPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_SWING_PAGE_H_
