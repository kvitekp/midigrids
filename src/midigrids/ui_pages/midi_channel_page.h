...
#ifndef MIDIGRIDS_UI_PAGES_MIDI_CHANNEL_PAGE_H_
#define MIDIGRIDS_UI_PAGES_MIDI_CHANNEL_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class MidiChannelPage : public UiPage {
 public:
  MidiChannelPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(MidiChannelPage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_MIDI_CHANNEL_PAGE_H_
