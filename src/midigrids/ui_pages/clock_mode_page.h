...
#ifndef MIDIGRIDS_UI_PAGES_CLOCK_MODE_PAGE_H_
#define MIDIGRIDS_UI_PAGES_CLOCK_MODE_PAGE_H_

#include "midigrids/ui_pages/ui_page.h"

namespace midigrids {

class ClockModePage : public UiPage {
 public:
  ClockModePage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(ClockModePage);
};

}  // namespace midigrids

#endif  // MIDIGRIDS_UI_PAGES_CLOCK_MODE_PAGE_H_
